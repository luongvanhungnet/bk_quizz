...
public class JsonAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response,
        ...
        objectMapper.writeValue(response.getWriter(), ApiEnvelope.failure("Bạn cần đăng nhập để tiếp tục.",
                List.of(new ApiFieldError("AUTH_REQUIRED", "Bạn cần đăng nhập để tiếp tục.")),
